if (WIN32 AND ${CMAKE_C_COMPILER} STREQUAL "cl" AND ${CMAKE_CXX_COMPILER} STREQUAL "cl")
  message(">> [NOTICE] If you get the error message \"Compiler not found\", run the CMake executable after running \"vcvarsall.bat\".")
  ...
  if(${VCVARSALL_LIST_LENGTH} GREATER 0)
    message(">> [NOTICE] \"vcvarsall.bat\": \"${VCVARSALL_LIST}\"")
  else()
    message(">> [NOTICE] \"vcvarsall.bat\" not found")
  endif()
endif()
